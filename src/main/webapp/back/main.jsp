    ...
    <div class="container-fluid">
        <div class="row">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
                            <div class="panel-body text-center">
                                <a class="btn btn-success" href="javascript:$('#content').load('${pageContext.request.contextPath}/banner/banner-show.jsp')">展示轮播图</a>
                            </div>
                        </div>
                    </div>
                    <div class="panel panel-default">
                        ...
                        <div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingTwo">
                            <div class="panel-body text-center">
                                <a class="btn btn-success" href="javascript:$('#content').load('${pageContext.request.contextPath}/album/album-show.jsp')">展示专辑</a>
                            </div>
                        </div>
                    </div>
                    <div class="panel panel-default">
                        ...
                        <div id="collapseThree" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingThree">
                            <div class="panel-body">
                                <a class="btn btn-success" href="javascript:$('#content').load('${pageContext.request.contextPath}/article/article-show.jsp')">展示文章</a>
                            </div>
                        </div>
                    </div>
                    <div class="panel panel-default">
                        ...
                        <div id="collapseFour" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingFour">
                            <div class="panel-body">
                                <a class="btn btn-success">展示用户</a>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-sm-10" id="content">
                ...
                <img src="${pageContext.request.contextPath}/back/shouye.jpg" style="width: 100%">
            </div>
        </div>
    </div>
    <%--页脚--%>
